...
# Case 2: displaying summary and excel output
def display_summary():
    ...
    # Export to Excel using openpyxl (through pandas)
    try:
        df.to_excel("expenses.xlsx", index=False, engine='openpyxl') #specify engine
...
def main():
    while True:
        print("\nExpense Tracker")
        print("1. Add expense")
        print("2. View summary and export to Excel")
